...
#################################### ExportCycle #################################
    ...
    RELATIVE_PATH = 'public/rest/api/1.0/cycle/{}/export?versionId={}&exportType=CSV&projectId={}'.format(cycle_id,VERSION_ID,PROJECT_ID)

    CANONICAL_PATH = 'GET&/public/rest/api/1.0/cycle/'+cycle_id+'/export/&'+ 'versionId=' + str(VERSION_ID) + '&exportType=CSV' + '&projectId=' + str(PROJECT_ID)
    ...
    raw_result1 = requests.get(BASE_URL + RELATIVE_PATH, headers=headers)
    print("raw result for test",raw_result1)
    json_result = json.loads(raw_result1.text)
    print("export data",json_result)
