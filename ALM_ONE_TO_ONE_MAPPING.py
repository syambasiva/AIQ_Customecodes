...
class UpdateStatusofjob:
    ...
    def execution_status(self, gentoken, platform_url, value):
    ...
    def GetStatus(self, AlmBaseUrl, ALM_cookie, value, instanceurl):
        ...
        print("TestSetStatus_UnderTestSeT",TestSetStatus_UnderTestSeT)
        print("TestidStatus_underTestPlan",TestidStatus_underTestPlan)
        Value = False
        ...
        try:
            ...
            for key, value in csv.items():
                if value[3] == '':
                    ...
                    print("reached else")
                    status, report, ExecutionIds = self.execution_status(gentoken, self.platformurl, value)
                ...
                if int(key) in status:
                    ...
                    if TestInstanceStatus == True:
                        ...
                        if int(key) in ExecutionIds:
                            ...
                            #print("Aiq steps list",aiq_steps_list)
                        ...
                        for i, j in zip(getrunids, aiq_steps_list):
                            #print("steps run id's",i)
                            #print("steps of Aiq",j)
...
##python run.py -AIQ_url https://client-demo.internal.autonomiq.ai/platform -AIQ_suite_id 80 -AIQ_user birlasoft01 -AIQ_pass 1234Birlasoft -ALM_secretekey apikey-efjekelmrqbjpnmtchca -ALM_Clientid mcpejieeebbikfbe -ALM_url http://useqawapqc01.na.ivc:8080 -csvfilePath "C:\\Users\\sairam\\OneDrive\\Desktop\\sambasiva\\New folder\\sampledata.csv"